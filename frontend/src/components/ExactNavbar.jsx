  ...
  return (
    <nav className="exact-nav">
      <div className="container exact-nav__container">
        ...
        <div className="exact-nav__logo" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <img src="/favicon-cropped.png" alt="SAAP Technowing" style={{ height: '60px', width: 'auto' }} />
          <span style={{ fontSize: '18px', letterSpacing: '-0.3px', lineHeight: 1 }}>
            <span className="exact-nav__logo-dark" style={{ fontWeight: '800' }}>SAAP</span>{' '}
            <span className="exact-nav__logo-blue" style={{ fontWeight: '600', letterSpacing: '0px' }}>Technowing</span>
          </span>
        </div>
        ...
        <div className="exact-nav__actions">
          <button className="btn exact-nav__whatsapp-btn">
